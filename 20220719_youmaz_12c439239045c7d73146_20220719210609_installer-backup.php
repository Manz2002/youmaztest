...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220719_youmaz_12c439239045c7d73146_20220719210609_archive.zip';
	const ARCHIVE_SIZE		 = '93982703';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '12c4392-19210609';
    const SECONDARY_PACKAGE_HASH = 'f330458-19210609';
	const VERSION			 = '1.4.7';
